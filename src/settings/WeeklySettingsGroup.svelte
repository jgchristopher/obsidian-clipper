		...
		>
			<div class="setting-item">
				<div class="setting-item-info">
					...
					<div class="setting-item-description">
						What header should highlight data be prepended/appended
						under in your daily note?
					</div>
				</div>
				<div class="setting-item-control">
					<input
			...
			<div class="setting-item">
				<div class="setting-item-info">
					...
					<div class="setting-item-description">
						Would you like to prepend clippings to the top of the
						section or append them to the bottom of the section?
					</div>
				</div>
				<div class="setting-item-control">
					<select
						class="dropdown"
						bind:value={$settings.weeklyPosition}
					>
